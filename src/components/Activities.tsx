    ...
    <section id="services" className="services" >
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 col-lg-3 d-flex align-items-stretch  mb-lg-0">
            <div className="icon-box" >
              ...
              <p className="description">PKS has always been at the forefront of promoting sports, hosting diverse competitions like the annual Ball Badminton Tournament for the Krishna Kumar Memorial Trophy, honoring a cherished member. Talented Ball Badminton players once graced PKS, their legacy enduring despite their absence. Today, PKS continues its tradition with a grand Annual Sports Meet during Onam, blending celebration and athleticism seamlessly.</p>
            </div>
          </div>
          <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div className="icon-box" >
              ...
              <p className="description">During its International Women’s Day Celebration every year in March, it has been helping the poor with cloths and other needy items, besides wheelchairs to the ‘divyang’ persons.</p>
            </div>
          </div>
          <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div className="icon-box" >
              ...
              <p className="description">PKS is a leading force in philanthropy, offering substantial aid during crises. It provided Rs 5 lakhs in support to Kerala during the 2018 and 2019 floods, and during the challenging Covid-19 pandemic. It also extended significant assistance during earthquakes in Gujarat and Latur (Maharashtra). Additionally, PKS supplied hundreds of tankers of drinking water to drought-affected villages in Maharashtra.</p>
            </div>
          </div>
        ...
        <div className="text-right">
          <Link to="/more-activities" className="btn btn-primary text-xs py-1 px-2">See More</Link>
        </div>
      </div>
    </section>
  );
