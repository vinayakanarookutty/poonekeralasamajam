...
const TimeLineItem: React.FC<TimeLineItemProps> = ({ image, date, title, desc }) => {
    return (
        <div className=' flex flex justify-center relative gap-10'>
            {/* <div className='h-2 w-full pl-10 bg-[#3b82f6] absolute z-[-1]'></div> */}
            <div className='w-[200px] md:w-[300px] pl-[100px] lg:w-[400px] xl:w-[550px] aspect-square overflow-hidden rounded flex items-center'>
